  ...
  return (
    <>
      ...
      {getViewPermissions('costs') ? (
        <div>
          <Card className="w-full border-l-8 border-t-0 border-b-0 border-r-0 border-tkyBlue" id="costs">
            <Form layout="vertical">
              <Text className="text-lg font-medium">{i18n(`newBillOfLadingHub.costs.title`)}</Text>
