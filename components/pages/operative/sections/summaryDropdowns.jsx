...
import { Badge, Dropdown, Tag, Timeline, Button, Form, Input, Radio, Space } from 'antd'
  ...
  return (
    ...
    >
      ...
      <Form.Item label="Created By">
        <Input placeholder="Created By" value={creator?.username} />
      </Form.Item>
      <Form.Item label="Manager">
        <Input placeholder="input placeholder" value={manager?.username} />
      </Form.Item>
      <Form.Item label="Create At">
        <Input placeholder="input placeholder" value={shipmentState.createdAt} />
      </Form.Item>
      <Form.Item label="Folio">
        <Input placeholder="input placeholder" value={shipmentState.folio} />
      </Form.Item>
      <Form.Item label="Client">
        <Input placeholder="input placeholder" value={shipmentState.clientName} />
      </Form.Item>
      <Form.Item label="Load">
        <Input placeholder="input placeholder" value={i18n(`shipmentStatusMenu.${shipmentState.loadType}`)} />
      </Form.Item>
      <Form.Item label="Trip">
        <Input placeholder="input placeholder" value={i18n(`shipmentStatusMenu.${shipmentState.tripType}`)} />
      </Form.Item>
      <Form.Item label="Mode">
        <Input placeholder="input placeholder" value={i18n(`shipmentStatusMenu.${shipmentState.modeType}`)} />
      </Form.Item>
      <Form.Item label="Service">
        <Input placeholder="input placeholder" value={i18n(`shipmentStatusMenu.${shipmentState.serviceType}`)} />
      </Form.Item>
      <Form.Item label="Recurrence">
        <Input placeholder="input placeholder" value={i18n(`shipmentStatusMenu.${shipmentState.recurrenceType}`)} />
      </Form.Item>
      <Form.Item label="Urgency">
        <Input placeholder="input placeholder" value={i18n(`shipmentStatusMenu.${shipmentState.urgencyType}`)} />
      </Form.Item>
      <Form.Item label="Option">
        <Input placeholder="input placeholder" value={i18n(`shipmentStatusMenu.${shipmentState.optionType}`)} />
      </Form.Item>
