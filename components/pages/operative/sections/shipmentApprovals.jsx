...
export const ShipmentApprovals = ({
  hubState,
  hubDispatch,
  getViewPermissions,
  ...
  return (
    <>
      <Card className="w-full border-l-8 border-t-0 border-b-0 border-r-0 border-tkyBlue" id='quotes'>
        <Form layout="vertical" onFinish={handleSubmit(onSubmitLoad)}>
        <Text className="text-lg font-medium">{i18n(`newBillOfLadingHub.approvals.title`)}</Text>
          <div className="mt-4">{i18n('newBillOfLadingHub.approvals.description')}</div>
