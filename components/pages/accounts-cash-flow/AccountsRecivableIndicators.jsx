      ...
      <Row justify="space-between" gutter={[8, 8]} className="mt-3">
        <Col xs={24} sm={24} md={12} lg={8} xl={8}>
          <Card className="w-full" hoverable>
            <Statistic title="Ventas Totales" prefix="USD" value={4521355.67} precision={2} formatter={formatter} />
          </Card>
        </Col>
        <Col xs={24} sm={24} md={12} lg={8} xl={8}>
          <Card className="w-full" hoverable>
            <Statistic title="Costos Totales" prefix="USD" value={1243345.55} precision={2} formatter={formatter} />
          </Card>
        </Col>
        <Col xs={24} sm={24} md={12} lg={8} xl={8}>
          <Card className="w-full" hoverable>
