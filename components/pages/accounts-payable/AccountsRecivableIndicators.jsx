      ...
      <Row justify="space-between" gutter={[8, 8]} className="mt-3">
        <Col xs={24} sm={24} md={12} lg={8} xl={4}>
          <Card className="w-full" hoverable>
            <Statistic title="Compras a Crédito" prefix="USD" value={889422.33} precision={2} formatter={formatter} />
          </Card>
        </Col>
        <Col xs={24} sm={24} md={12} lg={8} xl={4}>
          <Card className="w-full" hoverable>
            <Statistic title="Total Adeudado" prefix="USD" value={2387620.64} precision={2} formatter={formatter} />
          </Card>
        </Col>
        <Col xs={24} sm={24} md={12} lg={8} xl={4}>
          <Card className="w-full" hoverable>
        ...
        <Col xs={24} sm={24} md={12} lg={8} xl={4}>
          <Card className="w-full" hoverable>
            <Statistic title="Rotación de Cuentas por Pagar" value={12.55} precision={2} formatter={formatter} />
          </Card>
        </Col>
        <Col xs={24} sm={24} md={12} lg={8} xl={4}>
          <Card className="w-full" hoverable>
            <Statistic
              title="Prcentaje Facturas No Reconocidas"
              value={11.96}
              precision={2}
