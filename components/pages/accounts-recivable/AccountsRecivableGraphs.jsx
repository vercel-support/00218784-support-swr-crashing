    ...
    <>
      <Row justify="space-between" gutter={[8, 8]} className="mt-3">
        <Col xs={24} sm={24} md={12} lg={16}>
          <Card className="w-full" title="Cobros" extra={<a href="/accounts-recivable/payments">Detalle</a>}>
            <Chart chartType="Bar" width="100%" height="250px" data={paymentsData} options={paymentsOptions} />
          </Card>
        </Col>
        <Col xs={24} sm={24} md={12} lg={8}>
          <Card className="w-full" title="Envejecimiento" extra={<a href="/accounts-recivable/aging">Detalle</a>}>
