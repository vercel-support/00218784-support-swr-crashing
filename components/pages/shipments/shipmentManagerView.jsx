...
import { IdentificationSection } from './sections/IdentificationSection.jsx'
import { whatsAppSender } from '../../../services/whatsApp/whatsAppSender.js'
import { ShipmentStatus } from './sections/shipmentStatus.jsx'
...
export const ShipmentManagerView = () => {
  ...
  const [isPart, setIsPart] = useState('summary')

  useEffect(() => {
    setIsReadyToAction(data?.status?.isReadyToAction)
    setCompanyLogo(data?.companyLogo || '/taskility-logo.svg')
  }, [data])
      ...
      <Layout style={{ minHeight: '100vh' }}>
        ...
        <Affix offsetTop={top}>
          <Header className="bg-white pl-4 pr-4 ">
            ...
            <Text className="text-base font-medium">{i18n('managerView')}</Text>
        ...
        <HubDispatchContext.Provider value={dispatch}>
          <HubStateContext.Provider value={BoLHState}>
            ...
            <Content className="site-layout py-5 pl-5 pr-5 w-full lg:w-3/4 mx-auto " style={{ minHeight: '100vh' }}>
              ...
              {/* {isPart === 'Resumen' ? <ShipmentSummary hubState={BoLHState} hubDispatch={dispatch} loggedUserProfile={loggedUserIdData} /> : tabSwitch(currentTab)} */}
              {/* <Drawer
                width="80%"
