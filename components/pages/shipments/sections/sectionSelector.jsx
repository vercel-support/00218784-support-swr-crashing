...
export const SectionSelector = ({ hubDispatch, activeSections = ['generalInfo', 'locations'] }) => {
  ...
  return (
    <Checkbox.Group onChange={onChange} defaultValue={activeSections}>
      <Space direction="vertical" size={0}>
        ...
        <Checkbox checked={false} key="load" value="load">
        ...
        <Checkbox checked={false} key="events" value="events">
          {i18n('shipmentSections.events')}
        </Checkbox>
        <Checkbox checked={false} key="team" value="team">
          {i18n('shipmentSections.team')}
        </Checkbox>
        <Checkbox checked={false} key="documents" value="documents">
          {i18n('shipmentSections.documents')}
        </Checkbox>
        <Checkbox checked={false} key="tasks" value="tasks">
          {i18n('shipmentSections.tasks')}
        </Checkbox>
        <Checkbox checked={false} key="comments" value="comments">
          {i18n('shipmentSections.comments')}
        </Checkbox>
...
const TabTitle = ({ hubState, hubDispatch, section, settingsVisible = false, buttonType = 'plus', activeSections }) => {
  ...
  return (
    <div className="mt-8 mb-8">
      ...
      <Title level={3}>{i18n(section)}</Title>
