  ...
  return (
    <>
      ...
      {getViewPermissions('transports') ? (
        <div>
          <Card className="w-full border-l-8 border-t-0 border-b-0 border-r-0 border-tkyBlue" id="carriers">
            <Form layout="vertical" onFinish={handleSubmit(onSubmitLoad)}>
            <Text className="text-lg font-medium">{i18n(`newBillOfLadingHub.transport.title`)}</Text>
