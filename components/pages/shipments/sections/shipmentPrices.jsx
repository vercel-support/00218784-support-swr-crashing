  ...
  return (
    <>
      ...
      {getViewPermissions('prices') ? (
        <div>
          <Card className="w-full border-l-8 border-t-0 border-b-0 border-r-0 border-tkyBlue" id="prices">
            <Form layout="vertical">
              <Text className="text-lg font-medium">{i18n(`newBillOfLadingHub.prices.title`)}</Text>
