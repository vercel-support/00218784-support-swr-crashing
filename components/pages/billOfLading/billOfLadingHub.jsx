...
import { whatsAppSender } from '../../../services/whatsApp/whatsAppSender'
import { ShipmentStatus } from './sections/shipmentStatus'
import { TabTitle } from './sections/tabTitle'
import { ShipmentPrices } from './sections/shipmentPrices'
import { ShipmentCosts } from './sections/shipmentCosts'
import { ShipmentGeneralInfo } from './sections/shipmentGeneralInfo'
import { ShipmentLocations } from './sections/shipmentLocations'
import { ShipmentLoad } from './sections/shipmentLoad'
import { ShipmentCarriers } from './sections/shipmentCarriers'
import { ShipmentSatisfactionSurvey } from './sections/shipmentSatisfactionSurvey'
import { ShipmentQuotes } from './sections/shipmentQuotes'
import { DetailTabAnchor } from './sections/detailSectionAnchor'
import { ShipmentApprovals } from './sections/shipmentApprovals'
import { ShipmentDocuments } from './sections/shipmentDocuments'
import { EventsTab } from './sections/eventsTab'
import { TasksTab } from './sections/tasksTab'
import { CommentsTab } from './sections/commentsTabs'
import { TeamTab } from './sections/teamTab'
import { dateFormat } from '../../../services/helpers/dateFormat'
import { CurrentUserContext } from '../../contexts/currentUser'
import { HubDispatchContext, HubStateContext } from '../../contexts/shipmentHub'
import objectId from '../../../services/helpers/idGenerator'
...
export const BillOfLadingHub = () => {
  ...
  const { data, error } = useSWR(`/api/shipment-hub/get-bill-of-lading-hub-data?id=${id}`, post, {
      ...
      case 'details':
        return (
          <>
            ...
            />
            <ShipmentStatus hubState={BoLHState} hubDispatch={dispatch} loggedUserProfile={loggedUserIdData} />
