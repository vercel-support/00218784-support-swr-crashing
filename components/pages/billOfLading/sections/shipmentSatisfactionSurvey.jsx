...
export const ShipmentSatisfactionSurvey = ({
  hubState,
  hubDispatch,
  getViewPermissions,
  ...
  return (
    <>
      <Card className="w-full mt-20 border-l-8 border-t-0 border-b-0 border-r-0 border-tkyBlue" id='satisfactionSurveys'>
        <Form layout="vertical" onFinish={handleSubmit(onSubmitLoad)}>
          <Title level={4}>{i18n(`newBillOfLadingHub.satisfactionSurvey.title`)}</Title>
          <div className="mt-4">{i18n('newBillOfLadingHub.satisfactionSurvey.description')}</div>
