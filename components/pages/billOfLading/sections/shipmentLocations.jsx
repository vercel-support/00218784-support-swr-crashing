  ...
  return (
    <>
      ...
      {getViewPermissions('locations') ? (
        <div>
          <Card className="w-full mt-20 border-l-8 border-t-0 border-b-0 border-r-0 border-tkyBlue" id="locations">
            <Form layout="vertical" onFinish={handleSubmit(onSubmitRoute)}>
              <Title level={4}>{i18n(`newBillOfLadingHub.locations.title`)}</Title>
