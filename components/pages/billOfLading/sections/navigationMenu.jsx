...
export const HubNavigationMenu = ({ hubState, hubDispatch, currentTab, setCurrentTab }) => {
  ...
  return (
    <Affix offsetTop={top}>
      <Menu onClick={onClick} selectedKeys={[currentTab]} mode="horizontal" items={items} className="mt-0" />
